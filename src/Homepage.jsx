        ...
        <section id="hero">
          <div id="content">
            ...
            <p style={{ fontSize: "2vmin" }}>
              ...
              officia architecto ea fuga unde, atque dicta labore rerum omnis. A
              possimus laboriosam in.
            </p>
            <div>
          ...
          <div id="content2">
            ...
            <div id="icon">
              <div>
                ...
                <p
                  style={{ color: "rgba(93, 105, 112, 1)", fontSize: "2vmin" }}
                >
                  Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                  Maxime, ipsam ex. Magni deleniti explicabo voluptatem
                  voluptatibus voluptates sequi veniam incidunt cumque doloribus
                  aspernatur temporibus nulla, ipsum perspiciatis sed voluptas
                  laudantium!
                </p>
              </div>
              <div>
        ...
        <section id="section4">
          <div style={{ padding: "3vmin" }}>
            ...
            <p style={{ color: "rgba(111, 124, 178, 1)" }}>
              ...
              ipsum omnis, fugiat enim, necessitatibus quam tempora sunt nemo
              optio eum facilis facere. Error adipisci praesentium facere
              provident quo fugit quibusdam.
            </p>
